...
define( 'WPCACHEHOME', '/home3/mauibeats/bayareabeatsdjs.com/wp-content/plugins/wp-super-cache/' );
define('WP_CACHE', true); //Added by WP-Cache Manager
define('DB_NAME', 'mauibeat_bayareabeatsdjs');

/** MySQL database username */
define('DB_USER', 'mauibeat_bayare');
